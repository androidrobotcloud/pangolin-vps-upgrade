...
read-only
Files changed:
docs/reports/2026-06-17-pangolin-readonly-audit-v1-planner-proof.md
Commands run:
...
crowdsec   docker.io/crowdsecurity/crowdsec:latest   "/bin/bash /docker_s…"   crowdsec   12 hours ago   Up 12 hours (healthy)   0.0.0.0:6060->6060/tcp, [::]:6060->6060/tcp
gerbil     docker.io/fosrl/gerbil:1.4.0              "/entrypoint.sh --re…"   gerbil     12 hours ago   Up 12 hours             0.0.0.0:80->80/tcp, [::]:80->80/tcp, 0.0.0.0:443->443/tcp, [::]:443->443/tcp, 0.0.0.0:3479->3479/udp, [::]:3479->3479/udp, 0.0.0.0:21820->21820/udp, [::]:21820->21820/udp, 0.0.0.0:3479->3479/tcp, [::]:3479->3479/tcp, 0.0.0.0:51820->51820/udp, [::]:51820->51820/udp
pangolin   docker.io/fosrl/pangolin:1.18.3           "docker-entrypoint.s…"   pangolin   12 hours ago   Up 12 hours (healthy)   
traefik    docker.io/traefik:v3.6.16                 "/entrypoint.sh --co…"   traefik    12 hours ago   Up 12 hours             

...
read-only
Files changed:
docs/reports/2026-07-08-pangolin-upgrade-readiness-audit-v1-run.md
Commands run:
...
- Pangolin latest stable tag: 1.19.4
- Gerbil latest stable tag: 1.4.2
- Badger latest stable tag: v1.4.1
- Traefik latest stable tag: v3.7.6

Version audit:
- Pangolin: current 1.19.4 | current-line latest 1.19.4 | overall latest 1.19.4 | status current
...
- Traefik: current v3.7.6 | current-line latest v3.7.6 | overall latest v3.7.6 | status current
